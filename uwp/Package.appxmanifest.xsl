<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/formats">
		...
		<Package
			...
			<Identity Name="9998PiotrFusik.RECOIL" Publisher="CN=B70960AE-A992-475F-9A7E-4B341F4530CB" Version="{@version}.0" />
						...
						<uap:Extension Category="windows.fileTypeAssociation">
							<uap:FileTypeAssociation Name="recoil">
								...
								<uap:SupportedFileTypes>
									...
									<xsl:for-each select="platform/format/ext[not(. = following::ext) and . != 'MSP' and . != 'SCR' and . != 'ATR' and . != 'CPT']">
										<xsl:sort />
