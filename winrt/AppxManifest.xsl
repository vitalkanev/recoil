	...
	<xsl:template match="/formats">
		...
		<Package xmlns="http://schemas.microsoft.com/appx/2010/manifest">
			...
			<Properties>
				...
				<Logo>Logo.png</Logo>
				<Description>RECOIL (Retro Computer Image Library) is a viewer of pictures in native formats of classic home computers: Amiga, Amstrad CPC, Apple II, Atari 8-bit, Atari Portfolio, Atari ST, Atari Falcon, BBC Micro, Commodore 16, Commodore 64, Macintosh 128K, MSX, Oric, SAM Coupé, TRS-80, ZX81 and ZX Spectrum.</Description>
			</Properties>
			<Prerequisites>
