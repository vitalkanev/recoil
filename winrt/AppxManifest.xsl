	...
	<xsl:template match="/formats">
		...
		<Package xmlns="http://schemas.microsoft.com/appx/2010/manifest">
			...
			<Properties>
				...
				<Logo>Logo.png</Logo>
				<Description>RECOIL (Retro Computer Image Library) is a viewer of pictures in native formats of classic home computers: Amiga, Amstrad CPC, Atari 8-bit, Atari Portfolio, Atari ST, Atari Falcon, Commodore 16, Commodore 64, Macintosh 128K, MSX, Sam Coupé and ZX Spectrum.</Description>
			</Properties>
			<Prerequisites>
