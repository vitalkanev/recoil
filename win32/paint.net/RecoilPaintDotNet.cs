	...
	public class RecoilFileTypeFactory : IFileTypeFactory
	{
		public FileType[] GetFileTypeInstances()
		{
			return new FileType[] {
				...
				new RecoilFileType(".dlp", "Drazlace; 160x200, 2 frames, compressed"),
				...
				new RecoilFileType(".drl", "Drazlace; 160x200, 2 frames"),
				...
				new RecoilFileType(".fli", "lexible Line Interpratation; 148x200, 16 colors"),
				...
				new RecoilFileType(".fun", "Funpaint; 148x200, 16 colors, compressed"),
				...
				new RecoilFileType(".gun", "Gunpaint; 148x200, 16 colors"),
				...
				new RecoilFileType(".lp3", "Logo Painter 3+; 160x200, 4 colors"),
				...
				new RecoilFileType(".mci", "True Paint; 160x200, 2 frames"),
