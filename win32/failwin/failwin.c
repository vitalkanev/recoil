...
static void SelectAndOpenImage(void)
{
	static OPENFILENAME ofn = {
		...
		"Atari ST\0*.art;*.bl1;*.bl2;*.bl3;*.ca1;*.ca2;*.ca3;*.cpt;*.doo;*.gfb;*.iff;*.neo;*.pac;*.pc1;*.pc2;*.pc3;*.pcs;*.pi1;*.pi2;*.pi3;*.spc;*.sps;*.spu;*.tn1;*.tn2;*.tn3;*.tny\0"
