...
static void SelectAndOpenImage(void)
{
	static OPENFILENAME ofn = {
		...
		NULL,
		0,
		"All supported\0*.256;*.4mi;*.4pl;*.4pm;*.agp;*.all;*.ap2;*.ap3;*.apc;*.apl;*.app;*.apv;*.art;*.bg9;*.bkg;*.ca1;*.ca2;*.ca3;*.cci;*.chr;*.cin;*.cpr;*.dgp;*.dlm;*.doo;*.drg;*.esc;*.fnt;*.fwa;*.g09;*.g10;*.g11;*.ghg;*.gr7;*.gr8;*.gr9;*.hip;*.hr;*.hr2;*.ige;*.ilc;*.ing;*.inp;*.int;*.ist;*.jgp;*.max;*.mbg;*.mch;*.mcp;*.mgp;*.mic;*.mis;*.neo;*.pc1;*.pc2;*.pc3;*.pgc;*.pgf;*.pi1;*.pi2;*.pi3;*.pic;*.pla;*.plm;*.pzm;*.raw;*.rgb;*.rip;*.rm0;*.rm1;*.rm2;*.rm3;*.rm4;*.sge;*.shc;*.shp;*.spc;*.spu;*.sxs;*.tip;*.tn1;*.tn2;*.tn3;*.tny;*.wnd;*.xlp\0"
		...
		"Atari ST\0*.art;*.ca1;*.ca2;*.ca3;*.doo;*.neo;*.pc1;*.pc2;*.pc3;*.pi1;*.pi2;*.pi3;*.spc;*.spu;*.tn1;*.tn2;*.tn3;*.tny\0"
