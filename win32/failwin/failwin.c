...
static void SelectAndOpenImage(void)
{
	static OPENFILENAME ofn = {
		...
		"Atari 8-bit\0*.256;*.4mi;*.4pl;*.4pm;*.a4r;*.acs;*.agp;*.all;*.ap2;*.ap3;*.apc;*.apl;*.app;*.apv;*.art;*.bg9;*.bkg;*.cci;*.chr;*.cin;*.cpr;*.dgp;*.din;*.dlm;*.drg;*.esc;*.fnt;*.fwa;*.g09;*.g10;*.g11;*.ghg;*.gr7;*.gr8;*.gr9;*.hip;*.hpm;*.hr;*.hr2;*.icn;*.ige;*.ilc;*.imn;*.ing;*.inp;*.int;*.ip2;*.ipc;*.ist;*.jgp;*.max;*.mbg;*.mch;*.mcp;*.mcs;*.mgp;*.mic;*.mis;*.nlq;*.pic;*.pla;*.plm;*.pmd;*.pzm;*.raw;*.rgb;*.rip;*.rm0;*.rm1;*.rm2;*.rm3;*.rm4;*.sge;*.shc;*.shp;*.spc;*.sxs;*.tip;*.wnd;*.xlp\0"
