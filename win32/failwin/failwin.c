...
static void SelectAndOpenImage(void)
{
	static OPENFILENAME ofn = {
		...
		"Atari ST\0*.art;*.ca1;*.ca2;*.ca3;*.doo;*.gfb;*.neo;*.pac;*.pc1;*.pc2;*.pc3;*.pi1;*.pi2;*.pi3;*.spc;*.sps;*.spu;*.tn1;*.tn2;*.tn3;*.tny\0"
