...
static void SelectAndOpenImage(void)
{
	static OPENFILENAME ofn = {
		...
		NULL,
		0,
		"All supported\0*.256;*.ap3;*.apc;*.cci;*.cin;*.cpr;*.fnt;*.ghg;*.gr8;*.gr9;*.hip;*.hr;*.hr2;*.ige;*.ilc;*.inp;*.int;*.mch;*.mcp;*.mic;*.pic;*.plm;*.rip;*.sxs;*.tip\0"
		...
		"APAC-like (*.256;*.ap3;*.apc;*.ilc;*.plm)\0*.256;*.ap3;*.apc;*.ilc;*.plm\0"
