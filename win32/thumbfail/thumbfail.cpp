...
static const char extensions[][5] =
	{ ".256", ".4mi", ".4pl", ".4pm", ".a4r", ".acs", ".agp", ".all", ".ap2", ".ap3",
	  ...
	  ".del", ".dg1", ".dgc", ".dgp", ".dgu", ".dlm", ".doo", ".dph", ".drg", ".esc",
	  ".fnt", ".ftc", ".fwa", ".g09", ".g10", ".g11", ".gfb", ".ghg", ".god", ".gr7",
	  ".gr8", ".gr9", ".hip", ".hpm", ".hr",  ".hr2", ".iff", ".ige", ".ilc", ".ing",
	  ".inp", ".int", ".ipc", ".ist", ".jgp", ".max", ".mbg", ".mch", ".mcp", ".mcs",
