...
static const char extensions[][5] =
	{ ".256", ".all", ".ap2", ".ap3", ".apc", ".app", ".bg9", ".bkg", ".cci", ".chr",
	  ".cin", ".cpr", ".dgp", ".dlm", ".esc", ".fnt", ".fwa", ".g09", ".ghg", ".gr8",
	  ".gr9", ".hip", ".hr",  ".hr2", ".ige", ".ilc", ".inp", ".int", ".ist", ".jgp",
	  ".max", ".mbg", ".mch", ".mcp", ".mgp", ".mic", ".pic", ".plm", ".pzm", ".raw",
